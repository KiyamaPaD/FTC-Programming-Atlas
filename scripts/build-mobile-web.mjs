...
const MOBILE_MARKER = 'data-atlas-mobile="v59"'
...
function injectMobileRuntime(html) {
  ...
  const atlasScriptPattern =
    /<script\s+type=["']module["']\s+src=["']\/js\/atlas-script\.js\?v=52["']\s*><\/script>/i
  ...
  const mobileScripts = [
    atlasScript,
    '<script type="module" src="/js/atlas-i18n.js?v=78"></script>',
...
async function buildMobileWeb() {
  ...
  console.log('Included bilingual runtime: atlas-i18n v78 + v56')
}
